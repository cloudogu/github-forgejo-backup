...
// checks if the ChangeFilesOptions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChangeFilesOptions{}
...
type _ChangeFilesOptions ChangeFilesOptions
...
func (o ChangeFilesOptions) ToMap() (map[string]interface{}, error) {
...
func (o *ChangeFilesOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varChangeFilesOptions := _ChangeFilesOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangeFilesOptions)

	if err != nil {
		return err
	}

	*o = ChangeFilesOptions(varChangeFilesOptions)
