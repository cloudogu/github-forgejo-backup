...
type _CreateFileOptions CreateFileOptions
...
func (o *CreateFileOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateFileOptions := _CreateFileOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateFileOptions)

	if err != nil {
		return err
	}

	*o = CreateFileOptions(varCreateFileOptions)
