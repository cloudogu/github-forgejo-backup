...
func (o *CreateIssueOption) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateIssueOption := _CreateIssueOption{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateIssueOption)

	if err != nil {
		return err
	}

	*o = CreateIssueOption(varCreateIssueOption)
