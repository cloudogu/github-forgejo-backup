...
type _CreateKeyOption CreateKeyOption
...
func (o *CreateKeyOption) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateKeyOption := _CreateKeyOption{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateKeyOption)

	if err != nil {
		return err
	}

	*o = CreateKeyOption(varCreateKeyOption)
