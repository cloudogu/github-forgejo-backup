...
type _DeleteFileOptions DeleteFileOptions
...
func (o *DeleteFileOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteFileOptions := _DeleteFileOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteFileOptions)

	if err != nil {
		return err
	}

	*o = DeleteFileOptions(varDeleteFileOptions)
