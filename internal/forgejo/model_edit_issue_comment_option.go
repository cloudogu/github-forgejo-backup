...
type _EditIssueCommentOption EditIssueCommentOption
...
func (o *EditIssueCommentOption) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *EditIssueCommentOption) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *EditIssueCommentOption) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *EditIssueCommentOption) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}
...
func (o *EditIssueCommentOption) UnmarshalJSON(data []byte) (err error) {
	...
	varEditIssueCommentOption := _EditIssueCommentOption{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditIssueCommentOption)

	if err != nil {
		return err
	}

	*o = EditIssueCommentOption(varEditIssueCommentOption)
