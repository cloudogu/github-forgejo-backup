...
// checks if the LabelTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelTemplate{}
...
func (o LabelTemplate) ToMap() (map[string]interface{}, error) {
