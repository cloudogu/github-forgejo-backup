...
type _TransferRepoOption TransferRepoOption
...
func (o *TransferRepoOption) UnmarshalJSON(data []byte) (err error) {
	...
	varTransferRepoOption := _TransferRepoOption{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTransferRepoOption)

	if err != nil {
		return err
	}

	*o = TransferRepoOption(varTransferRepoOption)
